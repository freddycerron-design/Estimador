...
export const SYNTHETIC_PROJECTS: SyntheticProject[] = [
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 100, "Project Manager": 30 },
      "Diseño": { "UX/UI": 80, "Solution Architect": 40 },
      "Arquitectura": { "Solution Architect": 60 },
      "Desarrollo": { Developer: 640, "Data Engineer": 40 },
      "Integración": { Developer: 120, "Solution Architect": 20 },
      "Pruebas": { QA: 160 },
      "QA": { QA: 80 },
      "Despliegue": { DevOps: 60 },
      "Gestión de Proyecto": { "Project Manager": 140 },
      "Capacitación": { "Business Analyst": 24 },
    },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 80, "Project Manager": 30 },
      "Diseño": { "UX/UI": 160, "Solution Architect": 40 },
      "Arquitectura": { "Solution Architect": 70 },
      "Desarrollo": { Developer: 960 },
      "Integración": { Developer: 180 },
      "Pruebas": { QA: 220 },
      "QA": { QA: 100 },
      "Seguridad": { Security: 50 },
      "Despliegue": { DevOps: 90 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 120, "Project Manager": 40 },
      "Diseño": { "UX/UI": 180, "Solution Architect": 50 },
      "Arquitectura": { "Solution Architect": 90 },
      "Desarrollo": { Developer: 1200 },
      "Integración": { Developer: 260, "Solution Architect": 30 },
      "Pruebas": { QA: 260 },
      "QA": { QA: 120 },
      "Despliegue": { DevOps: 110 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 90, "Data Engineer": 40 },
      "Arquitectura": { "Solution Architect": 60, "Data Engineer": 40 },
      "Desarrollo": { "Data Engineer": 680 },
      "Integración": { "Data Engineer": 160 },
      "Pruebas": { QA: 100, "Data Engineer": 60 },
      "Despliegue": { DevOps: 50 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 220, "Project Manager": 60 },
      "Diseño": { "Solution Architect": 140 },
      "Arquitectura": { "Solution Architect": 180 },
      "Desarrollo": { Developer: 2400 },
      "Integración": { Developer: 480, "Solution Architect": 60 },
      "Pruebas": { QA: 520 },
      "QA": { QA: 180 },
      "Seguridad": { Security: 160 },
      "Despliegue": { DevOps: 220 },
      "Gestión de Proyecto": { "Project Manager": 380 },
      "Soporte/Hypercare": { Developer: 160, QA: 80 },
    },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 60, "Solution Architect": 30 },
      "Arquitectura": { "Solution Architect": 50 },
      "Desarrollo": { Developer: 420 },
      "Integración": { Developer: 140, "Solution Architect": 20 },
      "Pruebas": { QA: 100 },
      "Despliegue": { DevOps: 30 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 30 },
      "Diseño": { "UX/UI": 30 },
      "Desarrollo": { Developer: 280 },
      "Pruebas": { QA: 60 },
      "Despliegue": { DevOps: 16 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 35 },
      "Diseño": { "UX/UI": 25 },
      "Desarrollo": { Developer: 300 },
      "Pruebas": { QA: 65 },
      "Despliegue": { DevOps: 18 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 50, "Data Engineer": 40 },
      "Arquitectura": { "Solution Architect": 60, "Data Engineer": 40 },
      "Desarrollo": { "Data Engineer": 760, Developer: 160 },
      "Integración": { Developer: 120 },
      "Pruebas": { QA: 140, "Data Engineer": 60 },
      "Despliegue": { DevOps: 80 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 160, "Project Manager": 50 },
      "Diseño": { "UX/UI": 140, "Solution Architect": 70 },
      "Arquitectura": { "Solution Architect": 120 },
      "Desarrollo": { Developer: 1600 },
      "Integración": { Developer: 320, "Solution Architect": 40 },
      "Pruebas": { QA: 320 },
      "QA": { QA: 140 },
      "Seguridad": { Security: 220 },
      "Despliegue": { DevOps: 130 },
      "Gestión de Proyecto": { "Project Manager": 260 },
      "Capacitación": { "Business Analyst": 40 },
    },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 180, "Project Manager": 60 },
      "Diseño": { "Solution Architect": 130 },
      "Arquitectura": { "Solution Architect": 160 },
      "Desarrollo": { Developer: 2100 },
      "Integración": { Developer: 400, "Solution Architect": 60 },
      "Pruebas": { QA: 400 },
      "QA": { QA: 160 },
      "Seguridad": { Security: 280 },
      "Despliegue": { DevOps: 200 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 70, "Solution Architect": 30 },
      "Arquitectura": { "Solution Architect": 50 },
      "Desarrollo": { Developer: 480 },
      "Integración": { Developer: 160, "Solution Architect": 20 },
      "Pruebas": { QA: 110 },
      "Despliegue": { DevOps: 40 },
  ...
  },
  {
    ...
    effortHours: {
      ...
      "Diseño": { "UX/UI": 60 },
      "Arquitectura": { "Solution Architect": 90 },
      "Desarrollo": { Developer: 680 },
      "Integración": { Developer: 200 },
      "Pruebas": { QA: 150 },
      "Seguridad": { Security: 70 },
      "Despliegue": { DevOps: 90 },
      "Gestión de Proyecto": { "Project Manager": 110 },
    },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Solution Architect": 60 },
      "Arquitectura": { "Solution Architect": 100 },
      "Desarrollo": { DevOps: 520 },
      "Pruebas": { QA: 80, DevOps: 60 },
      "Seguridad": { Security: 60 },
      "Despliegue": { DevOps: 140 },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 200, "Project Manager": 60 },
      "Diseño": { "UX/UI": 160, "Solution Architect": 90 },
      "Arquitectura": { "Solution Architect": 140 },
      "Desarrollo": { Developer: 1900 },
      "Integración": { Developer: 380, "Solution Architect": 50 },
      "Pruebas": { QA: 360 },
      "QA": { QA: 160 },
      "Seguridad": { Security: 240 },
      "Despliegue": { DevOps: 160 },
      "Gestión de Proyecto": { "Project Manager": 320 },
      "Capacitación": { "Business Analyst": 50 },
    },
  ...
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 90, "Project Manager": 30 },
      "Diseño": { "UX/UI": 120, "Solution Architect": 40 },
      "Arquitectura": { "Solution Architect": 70 },
      "Desarrollo": { Developer: 900 },
      "Integración": { Developer: 180 },
      "Pruebas": { QA: 190 },
      "QA": { QA: 90 },
      "Despliegue": { DevOps: 80 },
    ...
    issuesEncountered: [],
    outcome: "Entregado a tiempo, dentro de presupuesto.",
    lessonsLearned: ["Plataformas LMS con proveedor de streaming externo (vs. hosting propio de video) reducen significativamente las horas de DevOps."],
  },
  {
    ...
    effortHours: {
      "Análisis": { "Business Analyst": 90, "Project Manager": 40 },
      "Diseño": { "UX/UI": 70, "Solution Architect": 60 },
      "Arquitectura": { "Solution Architect": 130 },
      "Desarrollo": { Developer: 3200, "Data Engineer": 480 },
      "Integración": { Developer: 620, "Solution Architect": 80 },
      "Pruebas": { QA: 340 },
      "QA": { QA: 140 },
      "Despliegue": { DevOps: 160 },
      "Gestión de Proyecto": { "Project Manager": 260 },
